...
void explainVector() {
  ...
  v.push_back(1);     // it inserts the element {1}
  ...
  might take garbage value,dependent on the vector*/
  ...
  // iterator simply means that you're
  // poiinting to that position, also it will not point the
  // first element but memory address b4 the first element.
  ...
  //! Be very careful, end doesn't point to 40, it will point to memory address
  //! after 40
